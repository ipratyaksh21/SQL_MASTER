...
-- SQL INTERVIEW QUESTONS FOR BEGINNERS
------------------------------------------------------------------------------------------------------------
/*. Create a Database : Corporate.*/
...
/*
26. Query name of every company together with every department
...
/*
27. Query name of every company together with departments without the 'Support' department
*/
SELECT com.name,dep.name
FROM company com, department dep
...
/*
28. Query employee name together with the department name that they are not working in
*/
...
/*
29. Query company name together with other companies names
LIKE:
GOOGLE Apple
GOOGLE IBM
Apple IBM
...
/*
30. Query employee names with salary smaller than 80 000 without using NOT and <
...
/*
31.Query names of every company and change the name of column to 'Company'
*/
SELECT name AS Company
FROM company;

/*
32. Query all employees that work in same department as Peter
*/
SELECT * FROM employee
